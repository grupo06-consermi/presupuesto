<?php
    ...
    class TCPDF_FONTS {
         ...
         *
         * @return mixed|string TCPDF font name or boolean false in case of error.
         * @author Nicola Asuni
                                ...
                                for ($k = 0; $k < $segCount; ++$k) {
                                    for ($c = $startCount[$k]; $c <= $endCount[$k]; ++$c) {
                                        if ($idRangeOffset[$k] == 0) {
                                            ...
                                            $gid = intval(floor($idRangeOffset[$k] / 2) + ($c - $startCount[$k]) - ($segCount - $k));
