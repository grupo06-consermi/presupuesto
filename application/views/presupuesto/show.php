...
<section style="padding: 1.5em">
    <div class="callout callout-info">
        <h2>Visualizar Presupuesto</h2>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">Presupuesto Nº <?php echo $pres_row->pres_cod; ?></h4>
        </div>
                ...
                <div class='row'>
                    <div class="col-xs-12 col-lg-4">
                        <div class="form-group">
                            ...
                            <select disabled required="required" name="cbo_clientes" id="cbo_clientes"
                                    class="form-control">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input disabled name="lugar_trabajo" id="lugar_trabajo" type="text"
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <input disabled name="encargado" id="encargado" type="text"
