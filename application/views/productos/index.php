<div class="container">
    ...
    <div class="col-xs-12">
        <a class="btn btn-success" href="<?= site_url(['producto', 'create']) ?>"
           style="margin-bottom: 1.3em; margin-top: 1.0em;  ">
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a title="Editar" class="btn btn-primary"
                                   href="<?= site_url('producto/edit/'.$row->prod_cod) ?>">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a title="Eliminar" class="btn btn-danger"
                                   href="<?= site_url('producto/destroy/'.$row->prod_cod) ?>">
