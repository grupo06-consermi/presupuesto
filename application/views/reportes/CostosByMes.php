...
?>
    <div class="row">
        <h2>Reporte de costos de presupuestos</h2>
...
<?php } ?>
    ...
    <script>
        var chart1_label     = [];
        var chart1_mano_obra = [];
        var chart1_materiales = [];
    </script>
<?php $i = 0; ?>
<?php foreach ($reporte as $item) { ?>
    <script>
        chart1_label[<?php echo $i; ?>]     = '<?php echo $item->mes_nombre; ?>';
        chart1_mano_obra[<?php echo $i; ?>] = '<?php echo $item->pres_costo_mano_obra; ?>';
        chart1_materiales[<?php echo $i; ?>] = '<?php echo $item->pres_costo_materiales; ?>';
        <?php $i++;  ?>
    </script>
<?php } ?>
                ...
                datasets: [
                    {
                        ...
                        type           : 'line',
                        label          : 'Materiales',
                        data           : chart1_materiales,
                        backgroundColor: [
                            'rgba(159,255,138,0.5)'
                        ],
                        borderWidth    : 0
                    }
                ]
